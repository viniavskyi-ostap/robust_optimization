...
This is the standard NLSQ implementation
"""
...
class NLSQ_Optimizer:
    ...
    def setupSparseJtJ(self):
        ...
        for obj in range(nObjs):
            ...
            # Prepare Hessian
            self.hessianIndices.append(
                [[[0 for i in range(nParamTypes)] for j in range(nParamTypes)] for k in range(nMeasurements)])
    ...
    def minimize(self):
        ...
        for currentIteration in range(self.maxIterations):
            ...
            print('----------------------------------------------------------------------')
            print("Current Iteration {}, Initial Cost = {}, Damping Value = {}".format(currentIteration, initial_cost,
                                                                                       self.damping_value))
            ...
            if (success_decrease):
                self.damping_value = max(1e-8, self.damping_value * 0.1)
